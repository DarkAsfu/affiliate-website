    ...
    <div className="my-0 md:my-10">
      <section>
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          {/* Left Image Section */}
          <aside className="hidden lg:block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6">
            <img
              alt="Nature"
          ...
          {/* Form Section */}
          <main className="flex items-center justify-center py-8 lg:col-span-7 lg:py-12 xl:col-span-6">
            <div className="">
              {/* Logo */}
